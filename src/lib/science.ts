...
export const SCIENCE_NOTES = [
  {
    title: "Cooling-off",
    body: "Present bias makes the now feel larger than the later. A waiting period lets slower, wiser thinking catch up. That is the same idea behind statutory cooling-off on big sales.",
  },
  {
    title: "Urge surfing",
